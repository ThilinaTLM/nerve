<script lang="ts">
  import { highlightCodeCached } from "@nervekit/ui/core/highlight/highlight";
  import { ansiToHtml } from "@nervekit/ui/core/terminal/ansi";
  import { trimTextPreview } from "@nervekit/ui/core/utils/text-preview";
  import {
