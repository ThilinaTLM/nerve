import { completeSimpleWithModel } from "../models/model-streaming.js";
import type { AgentMessage, AnyModel } from "../agent/contracts/index.js";
...
import type { BranchSummaryResult } from "../harness/lifecycle/events.js";
import {
  convertToLlm,
