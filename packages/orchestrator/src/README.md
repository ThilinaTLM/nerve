...
- `domains/tools/` execution plus managed process/explore-agent execution stay orchestrator-owned; `@nerve/tools` only executes local core tools and intentionally rejects orchestrator-managed capabilities.
