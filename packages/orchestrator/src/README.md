...
- `registry/project-lifecycle-service.ts`, `registry/conversation-lifecycle-service.ts`, and `registry/agent-lifecycle-service.ts` own project/conversation/agent persistence choreography and mutable lifecycle state updates.
- Conversation operation services own import/export/navigation/compaction behavior behind the registry facade.
