  ...
  <div class="audio-auth-body">
    <div class="audio-auth-summary">
      ...
      <div>
        ...
        <p>
          Nerve records from your microphone locally, then sends the captured
          audio to ChatGPT for transcription through the OpenAI Codex OAuth
          provider.
        </p>
      </div>
    </div>
    ...
    <div class="audio-auth-detail">
      ...
      <p>
        A free or paid ChatGPT account can be used. It just needs to be
        connected so the orchestrator can request transcription securely.
      </p>
    </div>

    <p class="audio-auth-path">
      To enable it, open <strong>Authentication</strong> →
      <strong>Subscriptions</strong>, then connect
