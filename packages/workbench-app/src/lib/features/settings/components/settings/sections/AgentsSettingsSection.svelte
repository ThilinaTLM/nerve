          ...
          <Tooltip.Root>
            ...
            <Tooltip.Content side="top" class="settings-policy-tooltip">
              <div class="settings-policy-tooltip-row">
                <span>File system read</span><strong
                  >{readPolicy(effectivePermissionLevel)}</strong
                >
              </div>
              <div class="settings-policy-tooltip-row">
                <span>File system write</span><strong
                  >{writePolicy(effectivePermissionLevel)}</strong
                >
              </div>
              <div class="settings-policy-tooltip-row">
                <span>Terminal commands</span><strong
                  >{commandPolicy(effectivePermissionLevel)}</strong
                >
              </div>
              <div class="settings-policy-tooltip-row">
                <span>Network access</span><strong>Tool-dependent</strong>
              </div>
            </Tooltip.Content>
          </Tooltip.Root>
        </Tooltip.Provider>
