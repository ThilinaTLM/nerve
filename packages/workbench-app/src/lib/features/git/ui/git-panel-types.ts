...
export type { FeatureCapability } from "$lib/kernel/capabilities/feature-capability";
import type { FeatureCapability } from "$lib/kernel/capabilities/feature-capability";
