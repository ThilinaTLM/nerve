...
<DocsScreenshot
  ...
  alt="The Nerve desktop workbench showing a coding conversation, its transcript, the composer, and the project panels scoped to the selected project"
  caption="What to notice: the selected project scopes the conversation navigator, task list, Git state, context, and notes — switching projects leaves the others untouched."
