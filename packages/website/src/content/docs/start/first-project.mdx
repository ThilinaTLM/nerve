...
import projectsDark from "../../../assets/screenshots/desktop/projects-dark.webp";
import projectsLight from "../../../assets/screenshots/desktop/projects-light.webp";
...
- Conversations, Files, Tasks, and Notes start in the left dock; Git, Pull Requests, and Context start in the right dock.
...
:::tip
Below 1024px, dock views move into compact sheets. Below 640px, Inbox, Chats, Workspace, and More become the primary phone navigation, with conversations and tools opening as focused detail screens. The same project and conversation data remains available.
:::

<DocsScreenshot
  light={projectsLight}
  dark={projectsDark}
  alt="The Nerve project switcher showing three local projects with activity indicators and workspace paths"
  caption="What to notice: each project keeps its own conversations, tasks, Git state, context, and notes, while activity remains visible when you switch away."
