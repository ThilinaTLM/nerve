...
| `/reference/tools/`                 | All 51 agent tool names grouped by file, execution, web, Atlassian, interaction, task, Explore, planning; risk/prereq/availability                                                        | Tools policy/integrations                  | State that Git/PR UI and Agent Browser are not tool entries                                 |
