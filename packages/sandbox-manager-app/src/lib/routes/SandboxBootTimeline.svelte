<script lang="ts">
  ...
  import type { ManagedSandboxRecord, StartupSetupStatus } from "@nervekit/contracts";
  import { Card, CardContent, CardHeader, CardTitle } from "@nervekit/workbench-ui/components/ui/card";
