...
type ProjectTaskMethodContext = Pick<
  WorkbenchOperationContext,
  "registry" | "services"
>;
const defineProjectTaskMethodHandlers =
  defineWorkbenchMethodHandlersFor<ProjectTaskMethodContext>();

export const projectTaskMethodHandlers: WorkbenchMethodHandlerMapFor<ProjectTaskMethodContext> =
  defineProjectTaskMethodHandlers({
