...
<html lang="en">
  <head>
    ...
    <style>${documentStyles()}
      ...
      main { width: min(760px, calc(100vw - 3rem)); padding: 2rem; }
      .eyebrow { color: var(--primary); text-transform: uppercase; letter-spacing: .2em; font-size: 0.75rem; }
      h1 { font-size: 3rem; margin: 0.75rem 0; color: var(--foreground); }
    </style>
  </head>
  <body>
    <main>
