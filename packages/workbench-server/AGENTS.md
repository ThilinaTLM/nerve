...
- Register protocol operations in the domain-grouped maps under `src/adapters/protocol/handlers/`. Do not recreate a central exhaustive switch or a second manually maintained operation list; the registry derives and verifies the workbench surface from the contracts catalog.
