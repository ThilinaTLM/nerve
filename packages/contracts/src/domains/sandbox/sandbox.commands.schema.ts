...
export const sandboxCommandParamsByMethod = {
  ...
  "git.repos.discover": z.object({}).optional(),
  "git.overview.get": sandboxGitRepoParamsSchema,
  "git.branches.list": sandboxGitRepoParamsSchema,
  "git.branch.create": createBranchRequestSchema,
  "git.branch.switch": switchBranchRequestSchema,
  "git.file.stage": gitFileActionRequestSchema,
  "git.file.unstage": gitFileActionRequestSchema,
  "git.file.discard": gitFileActionRequestSchema,
  "git.sync": gitRemoteOpRequestSchema,
  "git.push": gitRemoteOpRequestSchema,
  "git.pull": gitRemoteOpRequestSchema,
  "git.fetch": gitRemoteOpRequestSchema,
  "git.switchBaseAndPull": gitRemoteOpRequestSchema,
  "github.status.get": sandboxGitRepoParamsSchema,
  "github.pr.list": sandboxGitRepoParamsSchema,
  "github.pr.get": sandboxGithubPrParamsSchema,
  "github.pr.checkout": sandboxGithubPrParamsSchema,
  "task.list": z.object({}).optional(),
  "task.start": sandboxTaskStartParamsSchema,
  "task.get": sandboxTaskIdParamsSchema,
  "task.cancel": sandboxTaskCancelParamsSchema,
  "task.restart": sandboxTaskIdParamsSchema,
  "task.prune": z.object({}).optional(),
  "task.delete": sandboxTaskIdParamsSchema,
  "task.logs": sandboxTaskLogsParamsSchema,
} as const;
...
export const sandboxCommandResultByMethod = {
  ...
  "git.repos.discover": gitDiscoveryResponseSchema,
  "git.overview.get": gitOverviewResponseSchema,
  "git.branches.list": gitBranchListResponseSchema,
  "git.branch.create": gitMutationResponseSchema,
  "git.branch.switch": gitMutationResponseSchema,
  "git.file.stage": gitMutationResponseSchema,
  "git.file.unstage": gitMutationResponseSchema,
  "git.file.discard": gitMutationResponseSchema,
  "git.sync": gitMutationResponseSchema,
  "git.push": gitMutationResponseSchema,
  "git.pull": gitMutationResponseSchema,
  "git.fetch": gitMutationResponseSchema,
  "git.switchBaseAndPull": gitMutationResponseSchema,
  "github.status.get": githubStatusResponseSchema,
  "github.pr.list": githubPrListResponseSchema,
  "github.pr.get": githubPrDetailSchema,
  "github.pr.checkout": githubPrCheckoutResponseSchema,
  "task.list": z.object({ tasks: z.array(taskRecordSchema) }),
  "task.start": z.object({ task: taskRecordSchema }),
  "task.get": z.object({ task: taskRecordSchema }),
  "task.cancel": z.object({ task: taskRecordSchema }),
  "task.restart": z.object({ task: taskRecordSchema }),
  "task.prune": z.object({
    removed: z.array(z.string().startsWith("task_")),
  }),
  "task.delete": z.object({ removed: z.literal(true) }),
  "task.logs": taskLogQueryResponseSchema,
} as const;
